    ...
    <div>
      <Grid container style={styles.root} justifyContent="center">
        ...
        <Grid item xs={12}>
          ...
          <FormControl className={classes.formControl} required>
            <FormLabel id="50k6p">
              Suppose you owe $50,000 on a mortgage at an Annual Percentage Rate
              of 6%. If you didn’t make any payments on this mortgage how much
              would you owe in total after one year?
            </FormLabel>
            <RadioGroup
              row
          ...
          <FormControl className={classes.formControl} required>
            <FormLabel id="200k5p">
              ...
              Percentage Rate of 5%. If you made annual payments of $10,000 per
              year how long would it take to repay the whole mortgage?
            </FormLabel>
            <RadioGroup
              row
