        ...
        <Grid container style={styles.root} justifyContent="center">
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              ...
              feedback or questions by filling out the text box below. If you
              encountered any technical problems please let us know.
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <TextField
          ...
          <Grid item xs={12}>
            ...
            <Typography paragraph>
              <b>
                You will be shown a code on the next screen after you submit
                your answers that you must enter into prolific to get paid.
              </b>{" "}
            </Typography>
            <hr
              style={{
