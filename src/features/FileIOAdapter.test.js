import * as io from "./FileIOAdapter";
...
describe("FileIOAdapter tests", () => {
  ...
  // test("Validate feedback feedback file is written correctly.", () => {
  //   const feedback = {
  //     participantId: 1,
  //     feedback: "Feedback",
  //   };
  //   io.writeFeedback(feedback);
  // });

  // test("Validate financial literature survey file is written correctly.", () => {
  //   const survey = {
  //     participantId: 1,
  //     key1: "value1",
  //     key2: "value2",
  //   };
  //   io.writeFinancialLitSurvey(survey);
  // });

  // test("Validate purpose survey CSV fields are written correctly.", () => {
  //   const survey = {
  //     participantId: 1,
  //     key1: "value1",
  //     key2: "value2",
  //   };
  //   io.writePurposeSurvey(survey);
  // });

  // test("Validate demographics CSV file is written correctly.", () => {
  //   const demographics = {
  //     participantId: 1,
  //     countryOfResidence: "Country of residence",
  //     vizFamiliarity: "vis familiarity",
  ...
  //     profession: "profession",
  //   };
  //   io.writeDemographics(demographics);
  // });

  // test("Validate legal file is written correctly.", () => {
  //   const legal = {
  //     participantId: 1,
  //     consentChecked: true,
  //     attentionCheck: true,
  ...
  // test("Validate answer file written correctly.", () => {
  //   const answer1 = Answer({
  //     treatmentId: 1,
  //     position: 2,
  //     viewType: ViewType.word,
  ...
  //   });
  //   const answers = [answer1, answer2];
  //   io.writeAnswers(answers);
  // });

  test("Validate answer csv generated correctly.", async () => {
    const answer1 = Answer({
      treatmentId: 1,
      position: 2,
      viewType: ViewType.word,
    ...
    expect(result)
      .toBe(`treatmentId,position,viewType,interaction,variableAmount,amountEarlier,timeEarlier,dateEarlier,amountLater,timeLater,dateLater,maxAmount,maxTime,verticalPixels,horizontalPixels,leftMarginWidthIn,bottomMarginHeightIn,graphWidthIn,graphHeightIn,widthIn,heightIn,showMinorTicks,choice,dragAmount,shownTimestamp,choiceTimestamp,highup,lowdown,participantId
