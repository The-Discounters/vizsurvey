...
export const MELBarChartComponent = (props) => {
  ...
  const spec = {
    ...
    layer: [
      ...
      {
        transform: [{ filter: "datum.amount > 0" }],
        mark: { type: "rule" },
        encoding: {
          x: { field: "time", type: "ordinal", bandPosition: 0 },
          x2: { field: "time", type: "ordinal", bandPosition: 1 },
      ...
      },
      {
        ...
        encoding: {
          x: { field: "time", type: "ordinal", bandPosition: 0 },
          y: { datum: 0 },
          y2: { field: "amount", type: "quantitative" },
          color: { value: "black" },
          size: { value: 1 },
        },
      },
      {
        ...
        mark: { type: "rule" },
        encoding: {
          x: { field: "time", type: "ordinal", bandPosition: 1 },
          y: { datum: 0 },
          y2: { field: "amount", type: "quantitative" },
          color: { value: "black" },
          size: { value: 1 },
