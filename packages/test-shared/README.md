...
1. See instructions in packages/firebase/firebase/functions/README.md on how to start the emulator.
2. Run the command below to run the tests:
   `yarn run test`
3. If you want to shut the emulator off and run the tests on the live
